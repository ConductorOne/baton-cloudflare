...
```
docker run --rm -v $(pwd):/out -e BATON_ACCOUNT_ID=accountID -e BATON_API_KEY=apiKey -e BATON_EMAIL_ID=emailId public.ecr.aws/conductorone/baton-cloudflare:latest -f "/out/sync.c1z"
